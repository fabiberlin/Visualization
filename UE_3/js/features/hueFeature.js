...
HueFeature.prototype = {

    constructor: HueFeature,
    ...
    setFeature: function (featureName) {
        ...
        document.getElementById("chosen_hue").textContent = getFriendlyFeatureName(this.featureName);
    },
